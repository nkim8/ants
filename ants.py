    ...
    def remove_insect(self, insect):
        ...
        if insect.is_ant:
            ...
            if self.ant is insect:
                ...
                elif hasattr(self.ant, 'name') and self.ant.name == 'Queen':
                ...
                if hasattr(self.ant, 'container') and self.ant.container and self.ant.ant is insect:
                    if hasattr(self.ant.ant, 'name') and self.ant.ant.name == 'Queen':
                        if hasattr(self.ant.ant, 'impostor') and self.ant.ant.impostor:
                            self.ant.ant = None
                        else: 
                            return 
                    else:
...
class ThrowerAnt(Ant):
    ...
    damage = 1
    food_cost = 4
    min_range, max_range = 0, math.inf
    ...
    def nearest_bee(self, hive):
        ...
        while place is not hive and counter <= self.max_range:
            if place.bees == []:
                ...
                counter += 1
            elif place.bees != [] and counter >= self.min_range:
...
class QueenAnt(ScubaThrower):   # You should change this line
    ...
    def action(self, colony):
        ...
        if self.impostor:
            ...
            while place != None:
                if place.ant not in self.antlist and place.ant != None:
                    if not place.ant.container:
                        place.ant.damage *= 2
                        self.antlist.append(place.ant)
                    else:
                        if place.ant.ant != None and place.ant.ant not in self.antlist:
                            place.ant.damage *= 2
                            ...
                            place.ant.damage *= 2
                            self.antlist.append(place.ant)
                elif place.ant != None and place.ant.container and place.ant in self.antlist and place.ant.ant != None:
